...
class ContentSeeder extends Seeder
{
    protected $contents = [
        [
            'title' => '<span style="font:17px Arial, Verdana, Helvetica, sans-serif; font-weight:bold; color:#000066;font-weight:bold; ">Ultimate Guide to CDA Structured Interview: Tips &amp; Proven Strategies to Help You Prepare &amp; Ace Your CDA Interview</span>',
            'order_no' => 1,
            'text_data' => null,
        ],
        [
            'title' => '<span style="font:16px Arial, Verdana, Helvetica, sans-serif; font-weight:bold; font-weight:bold; ">Overview:</span>',
            'text_data' => '<span style="font:16px Arial, Verdana, Helvetica, sans-serif; "><br><br>The purpose of the dental school interview<br>History and rationale of the CDA interview <br>Types of Questions <br>The Seven Competencies<br>Structure of the CDA interview <br></span>'.
                            '<span style="font:16px Arial, Verdana, Helvetica, sans-serif; "><a href="how-to-prepare-for-cda-interview.html" rel="self" title="How To Prepare">How to prepare for your CDA Interview</a></span><br>'.
                            '<span style="font:16px Arial, Verdana, Helvetica, sans-serif; "><a href="sample-cda-interview-questions.html" rel="self" title="CDA Interview Questions">Sample CDA interview questions</a></span><br>'.
                            '<span style="font:16px Arial, Verdana, Helvetica, sans-serif; "><a href="http://bemoacademicconsulting.com/Dental-School-Interview-Preparation.html" rel="external" target="_blank">BeMo CDA-structured interview prep program</a></span><br>'.
